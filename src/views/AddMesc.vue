      ...
      <div class="content-area">
        ...
        <form class="form-container" @submit.prevent="handleSubmit">
          ...
          <div class="form-row">
            ...
            <input type="text" id="filiacao" v-model="formData.mae">
          </div>
          <div class="form-row">
            <label for="filiacao">Nome do Pai:</label>
            <input type="text" id="filiacao" v-model="formData.pai">
          </div>
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <input v-if="formData.movimentosPastorais === 'sim'" type="text" id="quaisMovimentos" v-model="formData.quaisMovimentos" placeholder="Quais movimentos?">
          </div>
