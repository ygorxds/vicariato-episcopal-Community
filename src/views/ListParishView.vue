<template>
          ...
          <table>
            ...
            <tbody>
              <tr v-for="(paroquia, index) in paroquias" :key="index">
                ...
                <td class="actions">
                  <button @click="viewParoquia(paroquia.id)"><i class="fas fa-eye"></i></button>
                  <router-link :to="{ name: 'ListParish', params: { id: paroquia.id } }">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const viewParoquia = (id: number) => {
        localStorage.setItem('paroquiaId', id.toString());
        router.push({ name: 'SeeParoquia' });
      };
