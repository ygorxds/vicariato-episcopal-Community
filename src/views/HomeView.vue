<template>
  ...
  <body>
    <div class="content-container">
      <div class="text-box">
        <p>Esta aplicação web foi desenvolvida com o objetivo de auxiliar o Vicariato Episcopal na gestão e inscrição
          dos MESCs, facilitando e otimizando os processos administrativos. Se você é um desenvolvedor e gostaria de
          contribuir com seu conhecimento, convidamos você a se juntar à nossa comunidade no Discord.</p>
...
.navbar {
  ...
  padding: 10px 20px;
  width: 100%;
  /* Estende o navbar para a largura total da tela */
  top: 0;
  left: 0;
  position: fixed;
  display: flex;
...
.participate-button {
  ...
  margin-top: 20px;
  /* Espaçamento superior para separar do texto */
}
...
.site-footer {
  ...
  /* Centraliza o texto */
  padding: 10px 0;
  /* Padding vertical para um bom espaçamento */
  width: 100%;
  /* Largura total */
  position: fixed;
